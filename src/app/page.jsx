  ...
  return (
    <div className='relative pt-[100px]'>
      ...
      <div className='flex justify-between items-center container z-10 pt-8'>
        <Image src='/homeview.png' width={500} height={500} className='animate-scale' alt='' />

        <div className='w-[50%] relative'>
          <h1 className='mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-BLACK'>DAILY <mark className="px-2 text-white bg-blue-600 rounded dark:bg-blue-500">NEWS</mark></h1>
